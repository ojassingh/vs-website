  ...
  return (
    <>
      <main className="relative flex h-full w-full items-center justify-center">
        <motion.ul
          className={`flex size-full flex-row flex-wrap items-center justify-center gap-4`}
          layout
...
function Card(props: { card: Card; onClick: () => void }) {
  return (
    <motion.li
      ...
      className="flex h-60 w-64 cursor-pointer flex-col justify-end rounded-[30px] bg-gray-100 px-7 py-8 text-[21px] text-balance text-gray-800 transition-colors hover:bg-gray-200"
          ...
          >
            ...
            >
              <div className="mx-auto max-w-xl">
                ...
                <motion.p
                  className="mt-4 text-[15px] text-gray-600"
...
export function Button(props: {
  ...
  return (
    <button
      className={`flex items-center justify-center rounded-full border-2 border-gray-300 p-2 text-gray-600 transition-colors hover:bg-gray-200 hover:text-gray-800 ${
        props.className || ""
      }`.trim()}
      onClick={props.onClick}
