...
import thumbnail from "@/../public/blog/safes_thumbnail.jpg";

export const metadata = {
  title: "SAFE Notes: A Comprehensive Guide for Startups",
  description: "A spelled-out guide on understanding SAFE Notes for early-stage startups.",
};

export const details = {
  title: "SAFE Notes: A Comprehensive Guide for Startups",
  description:
    "SAFE Notes provide an efficient way for early-stage startups to secure funding without the complexities of traditional methods. This guide explores their benefits, challenges, and best practices for leveraging this innovative funding model.",
  date: "2024-26-01",
